...
export const OrderPaymentReminder = (props: NewOrderPaymentRequiredEmailProps) => {
  const p = { ...defaults, ...props };

  return (
    <Html>
      <Head />
      <Preview>{p.companyName} - New Order Payment required</Preview>
...
export default OrderPaymentReminder;
