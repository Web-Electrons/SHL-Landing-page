...
export const metadata = {
  ...
  openGraph: {
    title: "ShipLink - Best Package Forwarding Service",
    description:
      "ShipLink is the world's best package forwarding service, offering worldwide coverage and secure shipping.",
...
export default function RootLayout({ children, params: { locale } }) {
  ...
  return (
    <NextIntlClientProvider locale={locale} messages={messages}>
      <TenstackProvider />
      <main className={cn("min-h-screen font-sans antialiased", roboto.variable)}>
