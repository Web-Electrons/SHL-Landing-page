                ...
                <div className="flex flex-row gap-2 items-start space-x-1 ">
                  ...
                  <Label className="flex flex-col cursor-pointer" htmlFor="r1">
                    ...
                    <p className="text-xs pt-2 w-full">
                      Hold package at the warehouse location it was received for you to pick up in
                      person. Fees must be prepaid online, payment is not available at warehouse
                      locations.
                    </p>
                  </Label>
                </div>
              ...
              <div className="flex flex-col space-x-2 bg-slate-100 rounded-sm border  p-3">
                <div className="flex flex-row gap-2 items-start space-x-1">
                  ...
                  <Label className="flex flex-col cursor-pointer" htmlFor="r3">
                    ...
                    <p className="text-xs pt-2">
                      ShipLink will process your package import and ship it to your selected address
                      domestically, from within the destination country.
                    </p>
                  </Label>
                </div>
              </div>
              <div className="flex flex-col space-x-2 bg-slate-100 rounded-sm border  p-3">
                <div className="flex flex-row gap-2 items-start space-x-1">
                  ...
                  <Label className="flex flex-col cursor-pointer " htmlFor="r4">
                    ...
                    <p className="text-xs pt-2">
                      Ship your package directly to your selected address, either domestic or
                      international using your selected carrier&apos;s own customs import process.
                    </p>
                  </Label>
                </div>
              </div>
