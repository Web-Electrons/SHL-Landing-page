                                ...
                                >
                                    ...
                                    <div className="">
                                        ...
                                        <div className="flex flex-col space-y-3">
                                            ...
                                            <div className="flex flex-row gap-3 space-x-3 justify-start h-[100%] w-full">
                                                            ...
                                                            <FormField
                                                                ...
                                                                render={({ field }) => (
                                                                    <FormItem
                                                                        className="w-full"
                                                                    >
                                                                        <FormLabel className="">Select Your Mailbox <span className='text-red-600'>*</span></FormLabel>
                                                                        <FormControl
                                                                            className="w-full"
                                                                        >
                                                                            <Select
                                            ...
                                            <div className="flex flex-row space-x-2 items-end w-full ">
                                                <div className="w-full">
                                                    <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                <FormLabel className="">Select Pacakge Type<span className='text-red-600'>*</span></FormLabel>
                                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                                    <FormControl>
                                                                        <SelectTrigger className=" my-2 h-[36px] text-xs">
                                                                            <SelectValue defaultValue={"HFP"} placeholder="Select Package Type" />
                                                                        </SelectTrigger>
                                                                    </FormControl>
                                                                    <SelectContent>
                                                                        <SelectItem value="HFP">Package</SelectItem>
                                                                        <SelectItem value="CBP">Pallet</SelectItem>
                                                                        <SelectItem value="CBF">Envelope</SelectItem>
                                                                    </SelectContent>
                                                                </Select>
                                                            </FormItem>
                                                        )}
